...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference("Competition.count") do
      post competitions_url, params: { competition: { name: @competition.name, start_date: @competition.start_date } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { name: @competition.name, start_date: @competition.start_date } }
